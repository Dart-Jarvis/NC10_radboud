...
factor=4.8e-10 # e.g., 4.8e-6, k_reverse rate constant relative to oxidation rate constant
t_lower=0.0001 # minimum time for time interval
t_upper=4 # maximum time for time interval, dimensionless
...
def dfdt(t,Y):
    ...
    Kf=K[0]*Y[0]+K[5]*Y[1]+K[2]*Y[2]+K[1]*Y[2]+K[6]*Y[3]+K[7]*Y[3]+K[3]*Y[4]+K[4]*Y[4]
    Kr=K[8]*Y[5]*Y[10]+K[13]*Y[6]*Y[10]+K[10]*Y[7]*Y[10]+K[9]*Y[5]*Y[11]+K[14]*Y[6]*Y[11]+K[15]*Y[8]*Y[10]+K[11]*Y[7]*Y[11]+K[12]*Y[9]*Y[10]
