...
SERIES_DATA_LABELS_FOR_LEGEND = {
    "ANME2d": "N-AOM (ANME, this study)",
    "AOM_P": "S-AOM (high sulfate 1)",
    "AOM_LS": "S-AOM (low sulfate 1)",
    MODEL_ONLY_SERIES_NAME: "Model-only series",
    MODEL_ONLY_SERIES_NAME_2: "S-AOM (low sulfate 2)",
    MODEL_ONLY_SERIES_NAME_3: "S-AOM (high sulfate 2)",
}
...
def make_plots(data, results_by_series):
    ...
    # Place the x-axis label and tick labels at the top, and place the y-axis
    # label and tick labels at the right. Tick marks remain visible on all sides.
    ax_clump0.xaxis.set_label_position("top")
    ax_clump0.yaxis.set_label_position("right")
