...
model="no INT"
F420=False
rev1_list=[0.0,0.31,0.55,0.61,0.9] # First-step reversibility list, CH4 <-> CH3-SCoM; each value ranges from 0 to <1
rev2_list=[0.0,0.80,0.6,0.99,0.95] # Second-step reversibility list, CH3-SCoM <-> CHO-MFR; each value ranges from 0 to <1
rev3_list=[0.0,0.00,0.25,0.02,0.95] # Third-step reversibility list, CHO-MFR <-> CO2; each value ranges from 0 to <1
t_lower=0.000 # minimum time for time interval
time_list=[35.0,50.0,100.0,100.0,380.0] # Maximum time for time interval, relevant to the final fraction of methane left
...
ax_bulk0.plot(normC_sMMO,normD_sMMO, linewidth=2.5, color="gray", alpha=1.0, label="sMMO (ab initio)", zorder=1)
...
ax_clump0.plot(normCD_sMMO,normDD_sMMO, linewidth=2.5, color="gray", alpha=1.0, label="sMMO (ab initio)", zorder=1)
...
ax_bulk1.plot(d13C[0,:],dD[0,:], linewidth=2.5, color="black", linestyle="--", alpha=1.0, label="Model, R1="+str(rev1_list[0])+", R2="+str(rev2_list[0])+", R3="+str(rev3_list[0]),zorder=1)
ax_bulk1.plot(d13C[1,:],dD[1,:], linewidth=2.5, linestyle="--", color="black", alpha=0.8,label="Model, R1="+str(rev1_list[1])+", R2="+str(rev2_list[1])+", R3="+str(rev3_list[1]),zorder=1)
ax_bulk1.plot(d13C[2,:],dD[2,:], linewidth=2.5, linestyle="--", color="black", alpha=0.6,label="Model, R1="+str(rev1_list[2])+", R2="+str(rev2_list[2])+", R3="+str(rev3_list[2]),zorder=1)
ax_bulk1.plot(d13C[3,:],dD[3,:], linewidth=2.5, linestyle="--", color="black", alpha=0.4, label="Model, R1="+str(rev1_list[3])+", R2="+str(rev2_list[3])+", R3="+str(rev3_list[3]), zorder=1)
ax_bulk1.plot(d13C[4,:],dD[4,:], linewidth=2.5, linestyle="--", color="black", alpha=0.3, label="Model, R1="+str(rev1_list[4])+", R2="+str(rev2_list[4])+", R3="+str(rev3_list[4]), zorder=1)


ax_bulk1.errorbar(ANME2d["d13C"],ANME2d["dD"],xerr=ANME2d["cse"],yerr=ANME2d["dse"], markersize=18,label=r'Nitrate-AOM', fmt='o', 
        markerfacecolor='none', markeredgecolor='red',markeredgewidth=3.5, ecolor='red', elinewidth=2.5, zorder=2)
ax_bulk1.errorbar(NC10["d13C"], NC10["dD"],xerr=NC10["cse"],yerr=NC10["dse"], markersize=18,label=r'Nitrite-AOM', fmt='v', 
        markerfacecolor='none', markeredgecolor='blue',markeredgewidth=3.5, ecolor='blue', elinewidth=2.5, zorder=2)
ax_bulk1.errorbar(AOM_P["d13C"],AOM_P["dD"],xerr=AOM_P["cse"],yerr=AOM_P["dse"], markersize=12,label=r'S-AOM (high sulfate)', fmt='s', 
        markerfacecolor='none', markeredgecolor='gray',markeredgewidth=3.5, ecolor='gray', elinewidth=2.5, zorder=-1)
ax_bulk1.errorbar(AOM_P_LS["d13C"],AOM_P_LS["dD"],xerr=AOM_P_LS["cse"],yerr=AOM_P_LS["dse"], markersize=12,fmt='^', label="S-AOM (low sulfate)",
        markerfacecolor='none', markeredgecolor='orange',markeredgewidth=3.5, ecolor='orange', elinewidth=2.5, zorder=-1)
ax_bulk1.errorbar(AOM_wegener["d13C"],AOM_wegener["dD"],xerr=AOM_wegener["cse"],yerr=AOM_wegener["dse"], markersize=12,  
        fmt='s', markerfacecolor='none', markeredgecolor='gray',markeredgewidth=3.5, ecolor='gray', elinewidth=2.5, zorder=-1)
ax_bulk1.errorbar(AOM_ono["d13C"],AOM_ono["dD"],xerr=AOM_ono["cse"],yerr=AOM_ono["dse"], markersize=12, 
                 fmt='s', markerfacecolor='none', markeredgecolor='gray',markeredgewidth=3.5, ecolor='gray', elinewidth=2.5, zorder=-1)
ax_bulk1.errorbar(AOM_wegener_LS["d13C"],AOM_wegener_LS["dD"],xerr=AOM_wegener_LS["cse"],yerr=AOM_wegener_LS["dse"], markersize=14,
                 fmt='^', markerfacecolor='none', markeredgecolor='orange',markeredgewidth=3.5, ecolor='orange', elinewidth=2.5, zorder=-1)
ax_bulk1.errorbar(AeOM_P["d13C"], AeOM_P["dD"],xerr=AeOM_P["cse"],yerr=AeOM_P["dse"], markersize=12,label=r'AeOM', fmt='D', 
        markerfacecolor='none', markeredgecolor='purple',markeredgewidth=3.5, ecolor='purple', elinewidth=2.5, zorder=-1)
ax_bulk1.errorbar(AeOM_P1["d13C"], AeOM_P1["dD"],xerr=AeOM_P1["cse"],yerr=AeOM_P1["dse"], markersize=12, fmt='D', 
        markerfacecolor='none', markeredgecolor='purple',markeredgewidth=3.5, ecolor='purple', elinewidth=2.5, zorder=-1)
ax_bulk1.plot(dC_sMMO,dD_sMMO, linewidth=2.5, color="purple", alpha=1.0, label="sMMO (ab initio)", zorder=1)
ax_bulk1.plot(dC_mcr_exp,dD_mcr_exp, linewidth=2.5, color="blue", alpha=1.0, label="MCR (experiment)", zorder=1)
set_axis(ax_bulk1,'$\delta^{13}$C (\u2030)','$\delta$D (\u2030)')
ax_bulk1.set_xlim([-68,10])
ax_bulk1.set_ylim([-180,260])
ax_bulk1.xaxis.set_minor_locator(MultipleLocator(4))
ax_bulk1.yaxis.set_minor_locator(MultipleLocator(10))
ax_bulk1.legend(fontsize=15)

fig_clump1,ax_clump1=plt.subplots(figsize=(12,12))
ax_clump1.plot(equib['D13CH3D'],equib['D12CH2D2'],'-k', label = 'Equilibrium', linewidth = 2.5, markersize = 15)
for i in range(len(equib)):
    if equib['p'].iloc[i]==1:
        ax_clump1.scatter(equib['D13CH3D'].iloc[i], equib['D12CH2D2'].iloc[i],color='black',s=60)


ax_clump1.plot(D13CH3D[0,:],D12CH2D2[0,:], linewidth=2.5, color="black", linestyle="--", alpha=1.0,zorder=1)
ax_clump1.plot(D13CH3D[1,:],D12CH2D2[1,:], linewidth=2.5, linestyle="--", color="black", alpha=0.8,zorder=1)
ax_clump1.plot(D13CH3D[2,:],D12CH2D2[2,:], linewidth=2.5, linestyle="--", color="black", alpha=0.6,zorder=1)
ax_clump1.plot(D13CH3D[3,:],D12CH2D2[3,:], linewidth=2.5, linestyle="--", color="black", alpha=0.4,zorder=1)
ax_clump1.plot(D13CH3D[4,:],D12CH2D2[4,:], linewidth=2.5, linestyle="--", color="black", alpha=0.3,zorder=1)
ax_clump1.errorbar(ANME2d["D13CH3D"],ANME2d["D12CH2D2"],xerr=ANME2d["cdse"],yerr=ANME2d["ddse"], markersize=18,label=r'Nitrate-AOM', fmt='o', 
        markerfacecolor='none', markeredgecolor='red',markeredgewidth=3.5, ecolor='red', elinewidth=2.5, zorder=2)
ax_clump1.errorbar(NC10["D13CH3D"], NC10["D12CH2D2"],xerr=NC10["cdse"],yerr=NC10["ddse"], markersize=18,label=r'Nitrite-AOM', fmt='v', 
        markerfacecolor='none', markeredgecolor='blue',markeredgewidth=3.5, ecolor='blue', elinewidth=2.5, zorder=2)
ax_clump1.errorbar(AOM_P["D13CH3D"],AOM_P["D12CH2D2"],xerr=AOM_P["cdse"],yerr=AOM_P["ddse"], markersize=12,label=r'S-AOM (High sulfate)', fmt='s', 
        markerfacecolor='none', markeredgecolor='gray',markeredgewidth=3.5, ecolor='gray', elinewidth=2.5, zorder=-1)
ax_clump1.errorbar(AOM_P_LS["D13CH3D"],AOM_P_LS["D12CH2D2"],xerr=AOM_P_LS["cdse"],yerr=AOM_P_LS["ddse"], markersize=12,label=r'S-AOM (Low sulfate)', fmt='^', 
        markerfacecolor='none', markeredgecolor='orange',markeredgewidth=3.5, ecolor='orange', elinewidth=2.5, zorder=-1)
ax_clump1.errorbar(AeOM_P["D13CH3D"], AeOM_P["D12CH2D2"],xerr=AeOM_P["cdse"],yerr=AeOM_P["ddse"], markersize=12,label=r'AeOM', fmt='D', 
        markerfacecolor='none', markeredgecolor='purple',markeredgewidth=3.5, ecolor='purple', elinewidth=2.5, zorder=-2)
ax_clump1.errorbar(AeOM_P1["D13CH3D"], AeOM_P1["D12CH2D2"],xerr=AeOM_P1["cdse"],yerr=AeOM_P1["ddse"], markersize=12, fmt='D', 
        markerfacecolor='none', markeredgecolor='purple',markeredgewidth=3.5, ecolor='purple', elinewidth=2.5, zorder=-2)
ax_clump1.plot(CD_sMMO,DD_sMMO, linewidth=2.5, color="purple", alpha=1.0, label="sMMO (ab initio)", zorder=1)
set_axis(ax_clump1,'$\Delta^{13}$CH$_3$D (\u2030)','$\Delta^{12}$CH$_2$D$_2$ (\u2030)')
ax_clump1.set_ylim([-55,80])
ax_clump1.set_xlim([-10,24])
ax_clump1.xaxis.set_minor_locator(MultipleLocator(2))
ax_clump1.yaxis.set_minor_locator(MultipleLocator(4))
ax_clump1.legend(fontsize=18)
...
plt.show()
if output==True:
    fig_bulk.savefig("bulk_model_no_f420.pdf",bbox_inches="tight")
    fig_clump.savefig("clump_model_no_f420.pdf",bbox_inches="tight")
    fig_f1.savefig("model_f1_no_f420.pdf",bbox_inches="tight")
    fig_f2.savefig("model_f2_no_f420.pdf",bbox_inches="tight")
    fig_f3.savefig("model_f3_no_f420.pdf",bbox_inches="tight")
    fig_f4.savefig("model_f4_no_f420.pdf",bbox_inches="tight")
